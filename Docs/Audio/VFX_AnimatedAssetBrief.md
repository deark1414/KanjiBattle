...
- Armor: a large close-up body-worn defensive overlay focused on a broad chest plate and shoulder guards, not a shield. Show only those upper-body armor parts at a readable scale, with an original design and no borrowed emblem or ornament. They should pop into place almost instantly, be surrounded by several sharp diamond-shaped star glints as a separate light effect rather than relying on metal gloss, and disappear as a whole immediately after the guard moment. Keep the kanji character readable behind or between the plates and avoid a long assembly sequence. Avoid circular radial rings, a central boss emblem, a tower-shield profile, projectiles, enemies, or a fully separate shield.
