...
- Armor: a body-worn defensive overlay, not a shield. Assemble recognizable shoulder, chest, arm, and leg armor plates around the character in sequence, with the kanji character remaining readable at the center. Use a brief metallic edge glint and small impact flecks, then settle into a compact plate silhouette and fade. Avoid circular radial rings, a central boss emblem, a tower-shield profile, projectiles, enemies, or a fully separate shield.
