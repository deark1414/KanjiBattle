...
- Armor: a body-worn defensive overlay, not a shield. Focus on recognizable shoulder, chest, arm, and leg armor plates around the character; they should pop into place almost instantly, flash with a brief metallic glint, and disappear abruptly after the guard moment. Keep the kanji character readable at the center and avoid a long assembly sequence. Avoid circular radial rings, a central boss emblem, a tower-shield profile, projectiles, enemies, or a fully separate shield.
