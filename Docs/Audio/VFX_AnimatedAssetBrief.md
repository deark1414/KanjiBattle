...
- Stone: a heavy stone that rises and falls almost in place at the target cell. Avoid a strong diagonal flight or sideways travel; use only a small vertical bob and scale change to communicate weight. End with a clear impact, then remove the stone itself so frames 7–8 contain only the lingering impact dust, small debris, and a fading ground mark.
